...
<head>
  ...
  <header id="main-header" class="sticky top-0 z-50 border-b border-white/10 bg-green-950/20 backdrop-blur">
    <div class="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-4 md:px-6">
      <a href="#" class="flex items-center gap-3 ">
        ...
        <div>
          ...
          <span class="text-xl font-semibold text-slate-100">Cidade Milenar</span>
        </div>
      </a>
      ...
      <nav id="mainNav" class="hidden absolute top-full left-0 right-0 z-40 flex-col gap-1 bg-slate-900/98 backdrop-blur-md border-b border-brandgreen/20 md:static md:flex md:flex-row md:items-center md:border-0 md:bg-transparent md:p-0 md:backdrop-blur-none md:gap-0 md:relative md:w-auto">
